...
% TODO:
% From McMillen:
% "Given the small size of the geographic areas, we aggregate the number of incidents to months to avoid an excess of zero counts." - p. 9
% Last paragraph of p. 9. Is about why focusing on counts instead of per capita rates.

% TODO:
% Mention why Poisson regression
% Talk about why fixed effects regression -> reason for FE is, that the program was "rolled out in a phased manner".
